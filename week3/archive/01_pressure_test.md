# Discharge Navigator — Rubric Pressure Test
...
**Discharge Navigator passes every requirement of the Week 3 rubric.** It is not a chatbot. It is not a RAG app. It is a multi-agent system with persistent state, conditional routing, tool use, error recovery, and principled human handoff — applied to one of the most broken workflows in American healthcare.
